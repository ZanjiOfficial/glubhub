    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupMembers", x => new { x.GroupsGroupId, x.MembersId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GroupMembers_Groups_GroupsGroupId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PostId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
<<<<<<<< HEAD:glubhub/Migrations/20251128084541_InitialCreate.cs
...
>>>>>>>> origin/MakingCommentsAndLikeLookNice:glubhub/Migrations/20251203185939_InitialCreate.cs
                },
                constraints: table =>
                {
